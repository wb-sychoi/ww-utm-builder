...
import NameGenerator from "../_components/name-generator/name-generator";
import { handleCreateAdGroupName, handleResetAdGroupName } from "./handler";

export default function CreateAdGroupName() {
  return (
    <>
      <NameGenerator
        id="ad-group-name-output"
        label="광고그룹명 생성하기"
        example="00.AA-자사몰_일반-BR-A-M-NSPW"
        handleCreate={handleCreateAdGroupName}
        handleReset={handleResetAdGroupName}
      />
